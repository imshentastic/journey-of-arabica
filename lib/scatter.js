document.addEventListener("DOMContentLoaded", () => {
    ...
    function update (xInput, yInput) {
        ...
        d3.csv("https://raw.githubusercontent.com/imshentastic/journey-of-arabica/master/assets/data/arabica-data.csv", function(data) {
            let pad = 0.3;
            ...
            svg.append("text")
                ...
                .text("Arabica Coffee Bean Reviews");
            svg.append("text")
                .attr("class","svgTitle")
                .attr("text-anchor","start")
                .attr("x", width/2.5)
            ...
            .append("text")
                ...
                .attr("y", function(d,i){ return i * (size + 5) + (size/3)}) 
                .style("fill", function(d){ return color(d)})
            ...
            let showTooltip = function(d) {
                ...
                tooltip
                    ...
                    .style("left", (document.getElementById("scatterZoom").clientWidth/7) + "px")
                    .style("top", (document.getElementById("scatterZoom").clientHeight/8) + "px");
            };
